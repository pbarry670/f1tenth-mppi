...
class MPPIControl(Node):
    ...
    def __init__(self):
        ...
        super().__init__("mppi_setspeed") #Name of node
    ...
    def publish_ackermann(self):
        ...
        ack_msg.drive.speed = self.speed #speed command, m/s
    ...
    def compute_cost(self, x_cuda, u_steer, u_throttle):
        ...
        ctrl_cost = torch.square(u_steer - self.prev_steer_cmd)
        #vel_cost = torch.square(self.V_DESIRED - x_cuda[3,:])

        cost = self.POS_COST_SCALER*pos_cost + self.HEADING_COST_SCALER*heading_cost + self.CTRL_INPUT_COST_SCALER*ctrl_cost
        return cost
