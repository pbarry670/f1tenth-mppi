...
class MPPIControl(Node):
    ...
    def __init__(self):
        ...
        self.HEADING_COST_SCALER = 1.0 #scalar parameter to tune cost associated with devition from ideal heading angle
    ...
    def publish_steercmds(self):
        ...
        self.steercmds_to_publish = Float32MultiArray(data=self.steercmds_to_publish)
        self.steering_publisher.publish(self.steercmds_to_publish)

    def publish_throttlecmds(self):
        throttle_msg = Float32MultiArray()
        self.throttlecmds_to_publish = Float32MultiArray(data=self.throttlecmds_to_publish)
    ...
    def compute_centerline(self):
        ...
        centerline_x = centerline_x + 0.15

        self.centerline_to_publish = np.concatenate((centerline_x, centerline_y))
...
def main(args=None):
    ...
    mppi.steercmds_to_publish = mppi.u_steer[:, index_optimal_trajectory]
    mppi.throttlecmds_to_publish = mppi.u_throttle[:, index_optimal_trajectory]
